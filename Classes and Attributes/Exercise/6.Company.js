class Company {
    ...
    addEmployee(username, salary, position, department) {
        ...
        this._departments[department].push(newEmploy);
    ...
    bestDepartment() {
        ...
        if (department != '') {
            ...
            Object.values(this._departments[department]).sort((a, b) => b.salary - a.salary || a.username.localeCompare(b.username)).forEach(e => {
